...
const serviceNamePattern = /^[A-Za-z0-9\u0600-\u06FF]+(?:[ A-Za-z0-9\u0600-\u06FF]+)*$/;
...
function validateService(data: Record<string, unknown>) {
  ...
  if (name.length > 120 || !serviceNamePattern.test(name)) return "Service name may contain letters, numbers and spaces only.";
